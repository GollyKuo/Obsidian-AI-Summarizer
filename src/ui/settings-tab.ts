...
export class AISummarizerSettingTab extends PluginSettingTab {
  ...
  private renderDiagnostics(containerEl: HTMLElement): void {
    renderDiagnosticsSection(containerEl, {
      diagnosticsLoading: this.diagnosticsLoading,
      hasVaultFilesystemAccess: this.hasVaultFilesystemAccess(),
      mediaToolInstallInProgress: this.mediaToolInstallInProgress,
      runtimeDiagnostics: this.runtimeDiagnostics,
      runtimeDiagnosticsError: this.runtimeDiagnosticsError,
      settings: this.plugin.settings,
      saveSettings: () => this.plugin.saveSettings(),
      onAutoDetectMediaToolExecutable: (settingKey, toolName) => {
      ...
      onPickMediaToolExecutable: (settingKey) => {
